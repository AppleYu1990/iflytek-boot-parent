...
import com.iflytek.common.exception.ExceptionEnum;
import com.iflytek.common.exception.IflytekException;
...
public class ResponseUtils {
    ...
    public static <T> Response<T> returnException(Exception e) {
        if (e instanceof IflytekException) {
            IflytekException ie = (IflytekException) e;
